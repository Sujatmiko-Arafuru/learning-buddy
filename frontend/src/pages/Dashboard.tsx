  ...
  const checkUserProgress = async () => {
    try {
      ...
      const hasSkillAssessment = Boolean(
        user?.skill_assessment && Object.keys(user.skill_assessment).length > 0
      );
      ...
      <Card className="mb-4">
        ...
        <Card.Body>
          {learningDataLoading ? (
            ...
            <Alert variant="info">
              Belum ada data learning path yang tersedia. Silakan pilih Map
              Interest terlebih dahulu.
            </Alert>
          ) : (
      ...
      <Card>
        ...
        <Card.Body>
          {recommendations.length === 0 ? (
            <Alert variant="info">
              Belum ada rekomendasi. Selesaikan onboarding untuk mendapatkan
